	...
	: QWidget(parent)
{
	...
	connect(ui.radioArp, &QRadioButton::clicked, [=] { MidiMaster::setParam(AN1xParam::Type::Common, AN1x::ArpSeqSelect, 0); });
	connect(ui.radioSeq, &QRadioButton::clicked, [=] { MidiMaster::setParam(AN1xParam::Type::Common, AN1x::ArpSeqSelect, 1); });
	connect(ui.radioScene1, &QRadioButton::clicked, [=] { MidiMaster::setParam(AN1xParam::Type::Common, AN1x::ArpSeqScene, 0); });
	connect(ui.radioScene2, &QRadioButton::clicked, [=] { MidiMaster::setParam(AN1xParam::Type::Common, AN1x::ArpSeqScene, 1); });
	connect(ui.radioBothScenes, &QRadioButton::clicked, [=] { MidiMaster::setParam(AN1xParam::Type::Common, AN1x::ArpSeqScene, 2); });
	connect(ui.arpType, &QComboBox::currentIndexChanged, [=](int index) { MidiMaster::setParam(AN1xParam::Type::Common, AN1x::ArpTypeSeqNo, index); });
	connect(ui.seqPatternNo, &QSpinBox::valueChanged, [=](int value) { MidiMaster::setParam(AN1xParam::Type::Common, AN1x::ArpTypeSeqNo, value - 1); });
	...
	connect(ui.seqLength, &QSpinBox::valueChanged, [=](int value) { MidiMaster::setParam(AN1xParam::Type::StepSq, AN1x::SeqLength, value); });
	...
	for (int i = 0; i < seq_controls.size(); i++) {
		...
		seq_controls[i]->setParam(AN1xParam::Type::StepSq, (AN1x::SeqParam)i);
	}
